 ...
 (def clojure-core
   ...
   (avoid-method-too-large
    {:obj clojure-core-ns
     ...
     'doseq-driver (copy-var doseq-macro/doseq-driver clojure-core-ns)
     ...
     'for-driver (copy-var for-macro/for-driver clojure-core-ns)
     'for-driver-cat (copy-var for-macro/for-driver-cat clojure-core-ns)
