(ns sci.impl.namespaces
  ...
  (:require
   ...
   #?(:clj [sci.impl.copy-vars :refer [copy-core-var maybe-copy-core-var
                                       copy-var macrofy new-var avoid-method-too-large]]
  ...
  #?(:cljs (:require-macros
            [sci.impl.copy-vars :refer [copy-var copy-core-var macrofy
                                        maybe-copy-core-var avoid-method-too-large]])))
 ...
 (def clojure-core
   (avoid-method-too-large
    (cond->
      ...
      #?(:clj (resolve 'abs)
         :cljs (sci.impl.cljs/cljs-resolve 'abs))
      (assoc 'abs (maybe-copy-core-var abs)))))
