...
## <a name="sci.core/*1">`*1`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L135-L135)
<a name="sci.core/*1"></a>

## <a name="sci.core/*2">`*2`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L136-L136)
<a name="sci.core/*2"></a>

## <a name="sci.core/*3">`*3`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L137-L137)
<a name="sci.core/*3"></a>

## <a name="sci.core/*e">`*e`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L138-L138)
<a name="sci.core/*e"></a>

## <a name="sci.core/add-class!">`add-class!`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L445-L455)
...
## <a name="sci.core/add-import!">`add-import!`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L457-L462)
...
## <a name="sci.core/add-namespace!">`add-namespace!`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L464-L469)
...
## <a name="sci.core/all-ns">`all-ns`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L476-L479)
...
## <a name="sci.core/alter-var-root">`alter-var-root`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L199-L205)
...
## <a name="sci.core/assert">`assert`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L133-L133)
<a name="sci.core/assert"></a>

SCI var that represents SCI's clojure.core/*assert*

## <a name="sci.core/binding">`binding`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L109-L116)
...
## <a name="sci.core/copy-ns">`copy-ns`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L363-L443)
...
## <a name="sci.core/copy-var">`copy-var`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L57-L78)
...
## <a name="sci.core/copy-var*">`copy-var*`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L80-L95)
<a name="sci.core/copy-var*"></a>
``` clojure
...
## <a name="sci.core/create-ns">`create-ns`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L269-L273)
...
## <a name="sci.core/enable-unrestricted-access!">`enable-unrestricted-access!`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L481-L487)
...
## <a name="sci.core/err">`err`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L121-L121)
<a name="sci.core/err"></a>

SCI var that represents SCI's `clojure.core/*err*`

## <a name="sci.core/eval-form">`eval-form`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L303-L310)
...
## <a name="sci.core/eval-string">`eval-string`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L218-L241)
...
## <a name="sci.core/eval-string*">`eval-string*`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L263-L267)
<a name="sci.core/eval-string*"></a>
``` clojure
...
## <a name="sci.core/file">`file`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L123-L123)
<a name="sci.core/file"></a>

SCI var that represents SCI's `clojure.core/*file*`

## <a name="sci.core/find-ns">`find-ns`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L471-L474)
...
## <a name="sci.core/fork">`fork`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L256-L261)
...
## <a name="sci.core/format-stacktrace">`format-stacktrace`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L317-L320)
...
## <a name="sci.core/future">`future`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L173-L178)
...
## <a name="sci.core/get-column-number">`get-column-number`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L290-L291)
...
## <a name="sci.core/get-line-number">`get-line-number`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L287-L288)
...
## <a name="sci.core/in">`in`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L119-L119)
<a name="sci.core/in"></a>

SCI var that represents SCI's `clojure.core/*in*`

## <a name="sci.core/init">`init`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L243-L249)
...
## <a name="sci.core/intern">`intern`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L207-L216)
...
## <a name="sci.core/merge-opts">`merge-opts`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L251-L254)
...
## <a name="sci.core/new-dynamic-var">`new-dynamic-var`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L36-L41)
...
## <a name="sci.core/new-macro-var">`new-macro-var`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L48-L55)
...
## <a name="sci.core/new-var">`new-var`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L29-L34)
...
## <a name="sci.core/ns">`ns`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L122-L122)
<a name="sci.core/ns"></a>

SCI var that represents SCI's `clojure.core/*ns*`

## <a name="sci.core/ns-name">`ns-name`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L322-L325)
...
## <a name="sci.core/out">`out`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L120-L120)
<a name="sci.core/out"></a>

SCI var that represents SCI's `clojure.core/*out*`

## <a name="sci.core/parse-next">`parse-next`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L293-L301)
...
## <a name="sci.core/parse-string">`parse-string`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L275-L279)
...
## <a name="sci.core/pmap">`pmap`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L180-L197)
...
## <a name="sci.core/print-dup">`print-dup`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L129-L129)
<a name="sci.core/print-dup"></a>

SCI var that represents SCI's `clojure.core/*print-dup*`

## <a name="sci.core/print-err-fn">`print-err-fn`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L131-L131)
<a name="sci.core/print-err-fn"></a>

SCI var that represents SCI's `cljs.core/*print-err-fn*`

## <a name="sci.core/print-fn">`print-fn`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L130-L130)
<a name="sci.core/print-fn"></a>

SCI var that represents SCI's `cljs.core/*print-fn*`

## <a name="sci.core/print-length">`print-length`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L125-L125)
<a name="sci.core/print-length"></a>

SCI var that represents SCI's `clojure.core/*print-length*`

## <a name="sci.core/print-level">`print-level`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L126-L126)
<a name="sci.core/print-level"></a>

SCI var that represents SCI's `clojure.core/*print-level*`

## <a name="sci.core/print-meta">`print-meta`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L127-L127)
<a name="sci.core/print-meta"></a>

SCI var that represents SCI's `clojure.core/*print-meta*`

## <a name="sci.core/print-newline">`print-newline`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L132-L132)
<a name="sci.core/print-newline"></a>

SCI var that represents SCI's `cljs.core/*print-newline*`

## <a name="sci.core/print-readably">`print-readably`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L128-L128)
<a name="sci.core/print-readably"></a>

SCI var that represents SCI's `clojure.core/*print-readably*`

## <a name="sci.core/read-eval">`read-eval`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L124-L124)
<a name="sci.core/read-eval"></a>

SCI var that represents SCI's `clojure.core/*read-eval*`

## <a name="sci.core/reader">`reader`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L281-L285)
...
## <a name="sci.core/resolve">`resolve`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L497-L498)
...
## <a name="sci.core/set!">`set!`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L43-L46)
...
## <a name="sci.core/stacktrace">`stacktrace`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L312-L315)
...
## <a name="sci.core/var->symbol">`var->symbol`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L489-L495)
...
## <a name="sci.core/with-bindings">`with-bindings`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L98-L107)
...
## <a name="sci.core/with-in-str">`with-in-str`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L144-L151)
...
## <a name="sci.core/with-out-str">`with-out-str`</a> [:page_facing_up:](https://github.com/babashka/sci/blob/master/src/sci/core.cljc#L154-L170)
