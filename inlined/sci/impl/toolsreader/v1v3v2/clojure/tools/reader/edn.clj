...
(ns ^{:no-doc true} sci.impl.toolsreader.v1v3v2.clojure.tools.reader.edn
  ...
  (:require [sci.impl.toolsreader.v1v3v2.clojure.tools.reader.reader-types :refer
            ...
            [sci.impl.toolsreader.v1v3v2.clojure.tools.reader.impl.utils :refer
            ...
            [sci.impl.toolsreader.v1v3v2.clojure.tools.reader :refer [default-data-readers]])
...
(defn read
  "Reads the first object from an IPushbackReader or a java.io.PushbackReader.
   ...
   sci.impl.toolsreader.v1v3v2.clojure.tools.reader.edn/read doesn't depend on dynamic Vars, all configuration
...
(defn read-string
  "Reads one object from the string s.
   ...
   opts is a map as per sci.impl.toolsreader.v1v3v2.clojure.tools.reader.edn/read"
