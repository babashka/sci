...
(ns ^{:no-doc true} sci.impl.toolsreader.v1v3v2.clojure.tools.reader
  (:refer-clojure :exclude [read read-line read-string char read+string
                            default-data-readers *default-data-reader-fn*
                            *read-eval* *data-readers* *suppress-read*])
  (:require [sci.impl.toolsreader.v1v3v2.clojure.tools.reader.reader-types :refer
            ...
            [sci.impl.toolsreader.v1v3v2.clojure.tools.reader.impl.utils :refer :all] ;; [char ex-info? whitespace? numeric? desugar-meta]
            [sci.impl.toolsreader.v1v3v2.clojure.tools.reader.impl.errors :as err]
            [sci.impl.toolsreader.v1v3v2.clojure.tools.reader.impl.commons :refer :all]
            [sci.impl.toolsreader.v1v3v2.clojure.tools.reader.default-data-readers :as data-readers])
  (:import (clojure.lang PersistentHashSet IMeta
                         RT Symbol Reflector Var IObj
                         PersistentVector IRecord Namespace)
           sci.impl.toolsreader.v1v3v2.clojure.tools.reader.reader_types.SourceLoggingPushbackReader
...
(def ^:dynamic *read-eval*
   ...
   ***WARNING***
   ...
   used with untrusted sources. See also: sci.impl.toolsreader.v1v3v2.clojure.tools.reader.edn/read.
...
(def ^:dynamic *data-readers*
  "Map from reader tag symbols to data reader Vars.
   ...
   Default reader tags are defined in sci.impl.toolsreader.v1v3v2.clojure.tools.reader/default-data-readers
...
(defn read
   ...
   ***WARNING***
   ...
   To read data structures only, use sci.impl.toolsreader.v1v3v2.clojure.tools.reader.edn/read

   Note that the function signature of sci.impl.toolsreader.v1v3v2.clojure.tools.reader/read and
   sci.impl.toolsreader.v1v3v2.clojure.tools.reader.edn/read is not the same for eof-handling"
...
(defn read-string
   ...
   ***WARNING***
   ...
   To read data structures only, use sci.impl.toolsreader.v1v3v2.clojure.tools.reader.edn/read-string

   Note that the function signature of sci.impl.toolsreader.v1v3v2.clojure.tools.reader/read-string and
   sci.impl.toolsreader.v1v3v2.clojure.tools.reader.edn/read-string is not the same for eof-handling"
  ([s]
     (read-string {} s))
  ([opts s]
